        ...
        >
            {project.link ? (
                <a
                    ...
                    className={`h-full bg-secondary p-2 rounded-xl xl:p-0 cursor-pointer`}
                >
                    <div
                        className={`h-full bg-secondary p-2 rounded-xl xl:p-0`}
                    >
                        <div
                ...
                <div className={`h-full bg-secondary p-2 rounded-xl xl:p-0`}>
                    <div
                        className="flex flex-col
                md:flex-col md:justify-center md:items-center
                lg:grid lg:grid-cols-10 lg:grid-rows-10 lg:justify-center lg:items-center lg:px-3 lg:h-full
